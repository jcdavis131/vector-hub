...
# DFS v7 per-domain MTNN independent-first + unified last phase — generated 2026-08-16T18:23:34.837609Z
...
## HOOPS — LOCAL_GPU_HANDOFF.md — 2026-08-16
...
## GRIDIRON — LOCAL_GPU_HANDOFF.md — 2026-08-16
...
## PITCH — LOCAL_GPU_HANDOFF.md — 2026-08-16
...
## EQUITIES — LOCAL_GPU_HANDOFF.md — 2026-08-16
...
- **Zero-deps true:** bundles/zero_deps.json {"zero_deps":true,"allow":"acne:./src"} no pip, no torch Hatch VM 2.1G OOM guard → LOCAL-GPU exempt.

## Swarm more faster — pacing :05

- **Pacing :05** sub-swarm 3 lanes parallel papercuts: Forms+Bloom 30s, Zep+CLS-RoPE 30s, VICReg+CORAL+SupCon+KaLM 30s → merge 90s total <3m max.
...
## Active-Tasks SSOT ≤15 rows preserve 3 LOCAL-GPU exempt snapshot 2026-08-16T18:23:34.875113Z
