# COORDINATION.md — Mirrored from bundles/coordination/active-tasks.md 2026-08-05T03:55Z UTC
# Source of truth outside = COORDINATION.md at repo root, inside Hatch = bundles/coordination/active-tasks.md
...
| Orchestrator | scout-cli / harness polish | 23:02 CDT | v0.8 harness manifest fs true net false + cli.sh wrapper perms + shared lib verify, no torch | scout/scout-cli-harness-polish | in-progress |
