...
## READY (pick me)
- [ ] hub 5th game chimera — unified chimera 20k+ cross-sport provenance 7/7/0 59 hashes LCG dailySeed — branch `scout/hub-chimera-5th`
- [ ] hub deploy Vercel unified 404→200 — one-click Production Domains — branch `scout/vercel-final-aug13`
- [ ] hub hoops-level polish 21.6k — map points visible dark bg single-select — branch `scout/hub-polish-hoops`
